          ...
          <div className="flex items-center justify-between w-full lg:flex-col">
           ...
           (max-width: 1200px) 50vw, 33vw"
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              <AnimatedText
                text="Full Stack Developer at your service. 
          "
                className="!text-6xl !text-left 
            xl:!text-5xl lg:!text-center lg:!text-6xl md:!text-5xl sm:!text-3xl"
              />
              <p className="my-4 text-base font-medium md:text-sm sm:text-xs">
                Hello! I&apos;m Žan Grajfoner, a passionate and experienced
                full-stack developer with a focus on Next.js, React, and C# .NET
                technologies. With a keen eye for detail and a dedication to
                creating robust, scalable solutions, I thrive in turning ideas
                into innovative, user-friendly applications.
              </p>
